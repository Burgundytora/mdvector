...
struct simd<float> {
  ...
  static inline const __m256i mask_table[8] = {
      ...
      _mm256_set_epi32(0, 0, 0, 0, 0, 0, 0, -1),       // 1个元素（仅最高位 e7 启用）
      _mm256_set_epi32(0, 0, 0, 0, 0, 0, -1, -1),      // 2个元素（e7, e6 启用）
      _mm256_set_epi32(0, 0, 0, 0, 0, -1, -1, -1),     // 3个元素（e7, e6, e5 启用）
      _mm256_set_epi32(0, 0, 0, 0, -1, -1, -1, -1),    // 4个元素（e7, e6, e5, e4 启用）
      _mm256_set_epi32(0, 0, 0, -1, -1, -1, -1, -1),   // 5个元素（e7, e6, e5, e4, e3 启用）
      _mm256_set_epi32(0, 0, -1, -1, -1, -1, -1, -1),  // 6个元素（e7, e6, e5, e4, e3, e2 启用）
      _mm256_set_epi32(0, -1, -1, -1, -1, -1, -1, -1)  // 7个元素（e7, e6, e5, e4, e3, e2, e1 启用）
  };
