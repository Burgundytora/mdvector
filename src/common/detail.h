...
void print_mdspan(std::mdspan<T, Extents, Layout> mdspan_) {
  ...
  if constexpr (Rank == 1) {
    ...
    for (size_t i = 0; i < mdspan_.extent(0); ++i) {
      std::cout << mdspan_[i];
      if (i < mdspan_.extent(0) - 1) std::cout << ", ";
    }
    std::cout << "]" << std::endl;
    ...
    for (size_t i = 0; i < mdspan_.extent(0); ++i) {
      ...
      for (size_t j = 0; j < mdspan_.extent(1); ++j) {
        ...
        if (j < mdspan_.extent(1) - 1) std::cout << ", ";
      }
      std::cout << "]" << std::endl;
    }
    std::cout << "]" << std::endl;
    ...
    for (size_t i = 0; i < mdspan_.extent(0); ++i) {
      ...
      for (size_t j = 0; j < mdspan_.extent(1); ++j) {
        ...
        for (size_t k = 0; k < mdspan_.extent(2); ++k) {
          ...
          if (k < mdspan_.extent(2) - 1) std::cout << ", ";
        }
        std::cout << "]";
        if (j < mdspan_.extent(1) - 1) std::cout << ",";
        std::cout << std::endl;
    ...
    for (size_t i = 0; i < mdspan_.size() && count < max_elements; ++i, ++count) {
      ...
      if (i < mdspan_.size() - 1 && count < max_elements - 1) std::cout << ", ";
    }
    if (mdspan_.size() > max_elements) std::cout << ", ...";
    std::cout << std::endl;
  }
}
