...
struct TestPoint {
  TestPoint(size_t dim1, size_t dim2, size_t dim3) : dim1_(dim1), dim2_(dim2), dim3_(dim3) {
...
vector<TestPoint> all_test_points = {TestPoint(3, 3, 3),    TestPoint(5, 5, 5),    TestPoint(7, 7, 7),
                                     TestPoint(10, 10, 10), TestPoint(20, 20, 20), TestPoint(50, 50, 50)};
